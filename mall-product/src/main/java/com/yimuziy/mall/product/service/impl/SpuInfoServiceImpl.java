...
import com.yimuziy.mall.product.entity.*;
import com.yimuziy.mall.product.feign.CouponFeignService;
import com.yimuziy.mall.product.feign.SearchFeignService;
...
import com.yimuziy.mall.product.dao.SpuInfoDao;
...
public class SpuInfoServiceImpl extends ServiceImpl<SpuInfoDao, SpuInfoEntity> implements SpuInfoService {
    ...
    public void saveSpuInfo(SpuSaveVo vo) {
        ...
        attrValueService.setProductAttr(collect);
        ...
        if (skus != null && skus.size() != 0) {
            skus.forEach(item -> {
                ...
                skuInfoEntity.setSkuDefaultImg(defaultImge);
                ...
                //5、4）、sku的优惠、满减等信息 mall-sms ->sms_sku_ladder  sms_sku_full_reduction  sms_member_price
    ...
    public void up(Long spuId) {
        ...
        //1、查出当前spu对应的的所有sku信息，品牌的名字。
        List<SkuInfoEntity> skus = skuInfoService.getSkusBySpuId(spuId);
        List<Long> skuIdList = skus.stream().map(SkuInfoEntity::getSkuId).collect(Collectors.toList());

        //TODO 4、查询当前sku的所有可以被用来检索属性规格
