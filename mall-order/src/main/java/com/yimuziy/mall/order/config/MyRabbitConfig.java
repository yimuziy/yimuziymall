...
public class MyRabbitConfig {
     ...
     *              消费者手动确认模式。只要我们没有明确告诉MQ，获取被签收。没有Ack，消息就一直unAcked状态。即时Consumer宕机。
     *                  消息不会丢失，会重新变为Ready，下一次有新的Consumer链接进来就发给他
     *      2、如何签收
    ...
    public void initRabbitTemplate() {
        ...
        rabbitTemplate.setReturnCallback(new RabbitTemplate.ReturnCallback() {
             ...
             * @param routingKey 当时这个消息发送用哪个路由键
             */
            @Override
